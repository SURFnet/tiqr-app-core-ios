...
class CreateEduIDEnterPersonalInfoViewController: ScrollingTextFieldsViewController {
    ...
    let emailField = TextFieldViewWithValidationAndTitle(title: "Your email address", placeholder: "e.g. timbernerslee@gmail.com", with: .email, keyboardType: .emailAddress)
    ...
    private func setupUI() {
        ...
        // - firstname
        firstNameField = TextFieldViewWithValidationAndTitle(title: "First name", placeholder: "e.g. Tim", with: .name, keyboardType: .default)
        firstNameField.tag = CreateEduIDEnterPersonalInfoViewController.firstNameFieldTag
        firstNameField.delegate = viewModel
        
        // - lastName
        lastNameField = TextFieldViewWithValidationAndTitle(title: "Last name", placeholder: "e.g. Berners-Lee", with: .name, keyboardType: .default)
