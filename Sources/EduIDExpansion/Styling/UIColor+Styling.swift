...
extension UIColor {
    static let primaryColor = UIColor(named: "PrimaryColor", in: Bundle.module, compatibleWith: nil)!
    static let backgroundColor = UIColor(named: "BackgroundColor", in: Bundle.module, compatibleWith: nil)!
    static let secondaryColor = UIColor(named: "SecondaryColor", in: Bundle.module, compatibleWith: nil)!
    static let disabledGray = UIColor(named: "GrayDisabled", in: Bundle.module, compatibleWith: nil)!
